...
var runCalculator = function () { return __awaiter(void 0, void 0, void 0, function () {
    var continueInput;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, calculator()];
            case 1:
                _a.sent();
            ...
            case 2:
                continueInput = _a.sent();
                if (!continueInput.continue) {
                    console.log("Goodbye!");
                }
                _a.label = 3;
            case 3:
                if (continueInput.continue) return [3 /*break*/, 0];
                _a.label = 4;
